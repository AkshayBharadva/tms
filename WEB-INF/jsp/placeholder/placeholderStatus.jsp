...
<!--                                            <h5 class="card-title">TEMPLATE TYPE :- ${i.TEMPLATE_TYPE_NAME}</h5>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card-body" id="loadFileUpload" style="display: none;">
                                        <form method="POST" action="placeholder.fin?cmdAction=uploadExcelFileWithData" name="excelfileform" enctype="multipart/form-data">
                                            ...
                                            <br>
                                            <div class="input-group">
                                                <button class="btn btn-outline-secondary" type="submit" id="inputGroupFileAddon04" onclick="uploadFile()">Upload File</button>
                                            </div>
                                        </form>
    ...
    <c:when test="${Action eq 'fileUploadmsg'}">
        <input type="hidden" name="fileUploadStatus" id="fileUploadStatus" value="${status}">
    </c:when>
